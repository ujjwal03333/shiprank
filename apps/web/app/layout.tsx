  ...
  return (
    ...
    >
      ...
      <body className="flex min-h-full flex-col">
        <a
          href="#main-content"
          className="sr-only focus:fixed focus:w-auto focus:h-auto focus:overflow-visible focus:[clip:auto] focus:whitespace-normal focus:m-0 focus:top-4 focus:left-4 focus:z-50 focus:rounded-md focus:bg-brand focus:px-4 focus:py-2 focus:text-ink-onbrand focus:shadow-lg"
        >
          Skip to content
        </a>
        <PageLoadingBar />
